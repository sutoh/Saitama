...
class EmployeeSkillsControllerTest < ActionController::TestCase
  ...
  test "should create employee_skill" do
    assert_difference('EmployeeSkill.count') do
      post :create, employee_skill: { employee_id: @employee_skill.employee_id, level: @employee_skill.level, skill_id: @employee_skill.skill_id }
    end
  ...
  test "should update employee_skill" do
    put :update, id: @employee_skill, employee_skill: { employee_id: @employee_skill.employee_id, level: @employee_skill.level, skill_id: @employee_skill.skill_id }
    assert_redirected_to employee_skill_path(assigns(:employee_skill))
  end
