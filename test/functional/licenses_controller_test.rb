...
class LicensesControllerTest < ActionController::TestCase
  ...
  test "should create license" do
    assert_difference('License.count') do
      post :create, license: { name: @license.name, note: @license.note, publisher: @license.publisher, validity_term: @license.validity_term }
    end
  ...
  test "should update license" do
    put :update, id: @license, license: { name: @license.name, note: @license.note, publisher: @license.publisher, validity_term: @license.validity_term }
    assert_redirected_to license_path(assigns(:license))
  end
